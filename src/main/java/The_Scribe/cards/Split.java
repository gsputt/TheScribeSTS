...
public class Split extends CustomCard implements CardSpellModifierInterface, CardSpellsInterface {
    ...
    public static final String ID = ScribeMod.makeID("Split");
    ...
    public static final String IMG = ScribeMod.makePath(ScribeMod.SCRIBE_SPLIT);
