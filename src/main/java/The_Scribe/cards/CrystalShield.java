...
public class CrystalShield extends AbstractScribeCard {
    ...
    public static final String ID = ScribeMod.makeID("CrystalShield");
    ...
    public static final String IMG = ScribeMod.makePath(ScribeMod.SCRIBE_CRYSTAL_SHIELD);
    ...
    private static final int TEMP_THORNS = 2;
    private static final int UPGRADE_TEMP_THORNS = 1;
    ...
    public CrystalShield() {
        ...
        this.baseMagicNumber = TEMP_THORNS;
    ...
    public void upgrade() {
        if (!this.upgraded) {
            this.upgradeName();
            this.upgradeMagicNumber(UPGRADE_TEMP_THORNS);
