...
public class Focused extends AbstractScribeCard implements CardSpellModifierInterface, CardSpellsInterface {
    ...
    public static final String ID = ScribeMod.makeID("Focused");
    ...
    public static final String IMG = ScribeMod.makePath(ScribeMod.SCRIBE_FOCUSED);
