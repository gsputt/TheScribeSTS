...
public class StarterModifier extends AbstractScribeCard implements CardSpellModifierInterface, CardSpellsInterface {
    ...
    public static final String ID = ScribeMod.makeID("StarterModifier");
    ...
    public static final String IMG = ScribeMod.makePath(ScribeMod.SCRIBE_STARTER_MODIFIER);
    ...
    private static final int UPGRADE_PLUS_EFFECTIVITY = 1;

    // /STAT DECLARATION/

    public StarterModifier() {
