...
import The_Scribe.powers.BlankScrollPower;
...
public class BlankScroll extends AbstractScribeCard implements CardSpellModifierInterface, CardSpellsInterface {
    ...
    public static final String ID = ScribeMod.makeID("BlankScroll");
    ...
    public static final String IMG = ScribeMod.makePath(ScribeMod.SCRIBE_BLANK_SCROLL);
