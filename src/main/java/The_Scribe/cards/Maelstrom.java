...
import The_Scribe.powers.MaelstromPower;
...
public class Maelstrom extends AbstractScribeCard {
    ...
    public static final String ID = ScribeMod.makeID("Maelstrom");
    ...
    public static final String IMG = ScribeMod.makePath(ScribeMod.SCRIBE_MAELSTROM);
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        applyPowers();
        AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(p, p, new MaelstromPower(p, this.magicNumber, this.cardsPlayedThisTurn), this.magicNumber));
