...
public class IcyDefend extends AbstractScribeCard implements CardSpellEffectInterface, CardSpellsInterface {
    ...
    public static final String ID = ScribeMod.makeID("IcyDefend");
    ...
    public static final String IMG = ScribeMod.makePath(ScribeMod.SCRIBE_ICY_DEFEND);
