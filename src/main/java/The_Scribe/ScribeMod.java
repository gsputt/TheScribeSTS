        ...
        PostBattleSubscriber, OnStartBattleSubscriber
{
    ...
    private static final String DESCRIPTION = "An attempt to create a character with a modular spell system NL NL thanks to Your_soul#6311 for proving a RUS localization";
    //MOD SETTINGS PANEL
    ...
    public static final String SCRIBE_GHOST_REALM = "cards/SpectralScroll.png";
    ...
    public static final String SCRIBE_SCROLL_OF_SHADOWS = "cards/ScrollOfShadows.png";
    public static final String SCRIBE_SCROLL_OF_CHAINING = "cards/ScrollOfChaining.png";
    public static final String SCRIBE_STATIC_SERIES = "cards/StaticSeries.png";
    public static final String SCRIBE_CAST_SKILL = "cards/CastSkill.png";
    public static final String SCRIBE_SCRIPTED_STARFALL = "cards/ScriptedStarfall.png";
    public static final String SCRIBE_TIME_DILATION = "cards/TimeDilation.png";
    public static final String SCRIBE_SCROLL_OF_SCRYING = "cards/ScrollOfScrying.png";
    public static final String SCRIBE_PIERCING_BOLTS = "cards/PiercingBolts.png";
    public static final String SCRIBE_CATALYTIC_CATASTROPHE = "cards/CatalyticCatastrophe.png";
    public static final String SCRIBE_WEIRD_TOXIN = "cards/WeirdToxin.png";
    public static final String SCRIBE_GLACIAL_GUARD = "cards/GlacialGuard.png";
    public static final String SCRIBE_FROSTVENOM_TOXIN = "cards/FrostvenomToxin.png";
    public static final String SCRIBE_TOXIC_SPELLSTONE = "cards/ToxicSpellstone.png";
    public static final String SCRIBE_QUICK_STUDY = "cards/QuickStudy.png";
    public static final String SCRIBE_INVIGORATING_STRIKE = "cards/InvigoratingStrike.png";
    public static final String SCRIBE_PAPER_CUT = "cards/PlaceholderAttack.png";
    public static final String SCRIBE_FRANTIC_SEARCH = "cards/FranticSearch.png";
    public static final String SCRIBE_OVEREXERT = "cards/Overexert.png";
    public static final String SCRIBE_THROWN_SCROLL = "cards/ThrownScroll.png";
    public static final String SCRIBE_DIVINATION = "cards/Divination.png";
    public static final String SCRIBE_GATHER_COMPONENTS = "cards/GatherComponents.png";
    public static final String SCRIBE_SANGUINE_SURGE = "cards/SanguineSurge.png";
    public static final String SCRIBE_GLACIES_SPELLSTONE = "cards/GlaciesSpellstone.png";
    ...
    public static final String SCROLL_OF_SHADOWS_POWER = "powers/ScrollOfShadowsPower.png";
    public static final String SPELL_CHAIN = "powers/SpellChain.png";
    public static final String SCROLL_OF_CHAINING_POWER = "powers/ScrollOfChainingPower.png";
    public static final String SCRIPTED_STARFALL_POWER = "powers/ScriptedStarfallPower.png";
    public static final String SCROLL_OF_SCRYING_POWER = "powers/ScrollOfScryingPower.png";
    public static final String SPELL_PIERCING_BOLTS = "powers/PiercingBoltsPower.png";
    public static final String REMOVE_SPLIT_AT_END_OF_TURN_POWER = "powers/SpellSplitDown.png";
