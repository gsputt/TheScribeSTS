...
public class EldritchApplyVulnerable extends CustomCard {
    ...
    public static final String ID = The_Scribe.ScribeMod.makeID("EldritchApplyVulnerable");
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String IMG = ScribeMod.makePath(ScribeMod.SCRIBE_ELDRITCH_APPLY_VULNERABLE);
    ...
    public EldritchApplyVulnerable() {
    ...
    public AbstractCard makeCopy() {
        return new EldritchApplyVulnerable();
    }
