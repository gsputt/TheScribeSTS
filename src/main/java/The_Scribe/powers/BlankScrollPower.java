...
import The_Scribe.cards.BlankScroll;
...
public class BlankScrollPower extends AbstractPower implements CloneablePowerInterface {
    ...
    {
        return new BlankScrollPower(this.owner, this.amount);
    }
