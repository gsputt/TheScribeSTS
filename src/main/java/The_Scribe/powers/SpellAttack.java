...
public class SpellAttack extends AbstractPower implements SpellEffectInterface, SpellsInterface, CloneablePowerInterface {
    ...
    {
        return new SpellAttack(this.owner, this.amount);
    }
