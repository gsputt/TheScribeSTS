...
public class MagicMissilesParticle extends AbstractGameEffect {
    ...
    public MagicMissilesParticle(float sX, float sY, float tX, float tY, boolean facingLeft) {
        ...
        this.color = new Color(28.0f, 00.0f, 80.0f, 0.6F);
        this.duration = 0.7F;
    ...
    private void updateMovement() {
        ...
        if (this.target.dst(this.pos) < DST_THRESHOLD) {
            ...
            CardCrawlGame.sound.playAV("ATTACK_MAGIC_FAST_1", MathUtils.random(0.6F, 0.9F), 0.5F);
